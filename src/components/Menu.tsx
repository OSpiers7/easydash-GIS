...
const Menu: React.FC<MenuProps> = ({ isDropDownOpen, setIsDropDownOpen }) => {
    ...
    <div className="menu-container" ref={menuRef}>
      ...
      >
        {!isLoggedIn ? (
          <button
            ...
            onClick={() => (
              setIsDropDownOpen(false), setIsLoginModalOpen(true)
            )}
          >
            Login
          </button>
      ...
      >
        <div className="modal-form">
          ...
          />
          {isFieldEmpty && (
            <p className="error-message">Email and password cannot be empty</p>
          )}
